...
#while 반복문에 대해서 공부해보자.
#while 반복문은 주어진 조건이 false가 될 때 반복을 탈출한다.
...
#파이선의 특징 같은데, 리스트 내에서 반복성질을 정의해서 재정의를 해줄 수 있다.
